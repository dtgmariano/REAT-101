...
\fancyhead[C]{PPGEB - FEELT - UFU $\bullet$ dezembro/2013} % Custom header text
...
\lstdefinestyle{sharpc}{language=[Sharp]C, frame=lr, rulecolor=\color{blue!80!black}, breaklines=true, basicstyle=\tiny}

%----------------------------------------------------------------------------------------
%	TITLE SECTION
%----------------------------------------------------------------------------------------

\title{\vspace{-15mm}\fontsize{24pt}{10pt}\selectfont\textbf{Desenvolvimento de um recurso de autocomplemento para um software de CAA, destinado para pacientes com limitação motora severa.}} % Article title
